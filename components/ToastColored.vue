<template>
  ...
  >
    ...
    >
      <div
        class="max-w-sm w-full border shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden"
        ...
        <div class="p-4">
          <div class="flex items-start">
            ...
            <div class="ml-4 flex-shrink-0 flex">
              <button
                @click="$emit('hidden')"
                class="rounded-md inline-flex hover:text-gray-100 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-white"
